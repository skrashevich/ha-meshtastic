...
CONF_OPTION_MQTT_PROXY = "mqtt_proxy"
CONF_OPTION_MQTT_PROXY_DOWNLINK = "downlink"
CONF_OPTION_MQTT_PROXY_DOWNLINK_DEFAULT = False
CONF_OPTION_MQTT_PROXY_UPLINK_RELAY = "uplink_relay"
CONF_OPTION_MQTT_PROXY_UPLINK_RELAY_DEFAULT = False
